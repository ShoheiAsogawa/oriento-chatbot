...
const orinyanMonthlyGreetings = [
  'あけましておめでとう、オリにゃんだよ！\n初日の出と松の内、こたつのぬくもりみたいな住まいを探すにゃん。',
  'こんにちは、オリにゃんだよ！\n節分もすぎて余寒の空に梅が香るころ。あたたかい住まいの話をするにゃん。',
  'こんにちは、オリにゃんだよ！\nひなまつりの桃、菜の花と桜待ち。春風といっしょにお部屋探しするにゃん。',
  'こんにちは、オリにゃんだよ！\nお花見の花吹雪から新緑へ。新生活の住まい、気軽に聞いてにゃん。',
  'こんにちは、オリにゃんだよ！\n鯉のぼりと若葉、薫風の季節だにゃん。住まい探し、のんびり付き合うにゃん。',
  'こんにちは、オリにゃんだよ！\n入梅の長雨に紫陽花、ほたるの夜も居心地のいい部屋を探すにゃん。',
  'こんにちは、オリにゃんだよ！\n入道雲の下、七夕の短冊と風鈴。涼しい住まいの願いを聞くにゃん。',
  'こんにちは、オリにゃんだよ！\n蝉時雨と盆の花火、残暑の日もお部屋の話でひと休みするにゃん。',
  'こんにちは、オリにゃんだよ！\n新涼に赤とんぼ、すすき揺れる十五夜。秋の住まいを探すにゃん。',
  'こんにちは、オリにゃんだよ！\n金木犀の香りと紅葉、実りの秋晴れ。住まいのこと、聞いてにゃん。',
  'こんにちは、オリにゃんだよ！\n霜の朝と小春日和、銀杏色づくころ。住まいの相談を一緒に考えるにゃん。',
  'こんにちは、オリにゃんだよ！\n師走と冬至、柚子湯のこたつのようにあたたかい住まいを探すにゃん。',
] as const;
